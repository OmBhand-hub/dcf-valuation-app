...
st.markdown("""
### How this app works
This tool estimates the **intrinsic value** of a stock using the Discounted Cash Flow (DCF) model.
It:
1. Pulls **Free Cash Flow**, **Market Cap** (Equity), and **Debt** from Yahoo Finance.
2. Calculates the **Weighted Average Cost of Capital (WACC)** using fixed assumptions.
3. Projects future cash flows, discounts them, and adds a **terminal value**.
4. Compares the intrinsic value to the current market price to see if it’s **undervalued** or **overvalued**.
---
""")
...
# ----------------------------
st.header("Step 1: Pull the company’s key financials")
...
# ----------------------------
st.markdown("---")
st.header("Step 2: Calculate the company's cost of capital")
...
# ----------------------------
st.markdown("---")
st.header("Step 3: Project the company’s future cash flows")
...
st.subheader(f"💰 Estimated Intrinsic Value: **{money_short(dcf_value*1e6)}**")
